...
class ParseExcel(object):
    ...
    def getColumn(self, sheet, colNo):
        # 获取sheet某一列，返回的是这一列所有的数据内容组成的tuple
...
if __name__ == '__main__':
    pe = ParseExcel()
    # 测试Excel文件"登录用户信息.xlsx"
    pe.loadWorkBook('E:\\python\\ERP_selenium UI自动化(Python)\\第十四课\\testData\\登录用户信息.xlsx')
    ...
    pe.writeCell(sheet, 'python关键字驱动', rowNo=5, colsNo=1)
    pe.writeCellCurrentTime(sheet, rowNo=5, colsNo=2)
