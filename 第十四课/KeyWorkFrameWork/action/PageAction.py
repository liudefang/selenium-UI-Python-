...
from KeyWorkFrameWork.config.VarConfig import ieDriverFilePath, firefoxDriverFilePath
from KeyWorkFrameWork.util.DirAndTime import getCurrentTime, createCurrentDateDir
from KeyWorkFrameWork.util.ObjectMap import getElement

from KeyWorkFrameWork.util.WaitUtil import WaitUtil
...
def wait_Frame_To_Be_Available_And_Switch_To_It(locationType, locatorExpression, *args):
    ...
    global waitUtil
    try:
        waitUtil.frame_available_and_swith_to_it(locationType, locatorExpression, *args)
    except Exception as e:
        raise e
